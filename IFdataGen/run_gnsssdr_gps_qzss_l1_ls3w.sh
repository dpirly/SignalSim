...
CONFIG="${SCRIPT_DIR}/gnsssdr-configs/GPS_QZSS_L1CA_LS3W_10p5.conf"
LOG="${SCRIPT_DIR}/gnsssdr_gps_qzss_l1_ls3w_10p5.log"
...
cd "${SCRIPT_DIR}"
echo "Running GNSS-SDR GPS L1 C/A + QZSS L1 C/A LS3W analysis"
echo "  config: ${CONFIG}"
echo "  input : ${LS3W}"
echo "  log   : ${LOG}"
